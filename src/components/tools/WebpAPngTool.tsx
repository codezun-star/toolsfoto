...
export default function WebpAPngTool() {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="space-y-5">
        <div className="p-5 bg-white rounded-xl border border-[var(--color-border)]">
          <h2 className="font-bold text-[var(--color-text)] mb-2">PNG con transparencia</h2>
          <p className="text-sm text-[var(--color-text-secondary)] leading-relaxed">La conversión conserva el canal alfa (transparencia) del WebP original. Ideal para compatibilidad con programas y plataformas que no admiten WebP, manteniendo la calidad sin pérdida.</p>
        </div>
