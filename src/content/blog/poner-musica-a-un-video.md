---
titulo: "Cómo añadir música o audio a un vídeo gratis y sin programas"
...
keywords:
  ...
  - "añadir audio a video sin programas"
...
Antes de empezar, define qué quieres conseguir, porque son operaciones distintas:

| Modo | Qué hace | Cuándo usarlo |
|---|---|---|
| **Reemplazar el audio** | Elimina el sonido original y pone el nuevo | Cuando el audio original es ruido, está mal grabado o no lo quieres |
...
### Opción A — Reemplazar el audio original

Úsala cuando el audio original tiene ruido, voces que no quieres, o simplemente es silencio y quieres poner música.

1. Abre [Añadir audio a vídeo](/anadir-audio-video).
2. Sube el vídeo (MP4, WebM, MOV).
3. Sube el archivo de audio (MP3, WAV, AAC).
4. Selecciona **"Reemplazar audio"**.
5. Haz clic en procesar y descarga el resultado.

Si la música es más larga que el vídeo, se corta automáticamente al terminar el vídeo. Si es más corta, el audio termina antes de que acabe el vídeo (el final queda silencioso).

### Opción B — Mezclar el audio original con música de fondo

Úsala para tutoriales, presentaciones o vlogs donde quieres que se oiga la voz pero con música suave de ambiente.

1. En la misma herramienta, sube el vídeo y el audio.
2. Selecciona **"Mezclar audios"**.
...
### Añadir música a un slideshow de fotos

Si has creado un vídeo slideshow con la herramienta [Fotos a vídeo](/fotogramas-a-video), el resultado es un vídeo silencioso. Añadir música de fondo lo transforma completamente. Sube el slideshow y la canción en [Añadir audio a vídeo](/anadir-audio-video) y elige "Reemplazar audio".

### Vídeo de presentación con voz en off

Graba tu narración por separado (con el micrófono del móvil, por ejemplo) y añádela al vídeo de la presentación como reemplazo del audio original.

### Tutoriales con explicación hablada

Graba el tutorial y la explicación por separado, luego combínalos. Así puedes re-grabar solo la voz sin repetir toda la demostración.

### Vídeos para redes sociales sin derechos de autor
...
- **+6 dB**: dobla el volumen percibido (bastante notorio).
...
El flujo más habitual para crear un vídeo con música perfectamente ajustada:

1. **Silencia el vídeo original** → [Silenciar vídeo](/silenciar-video) — elimina el ruido original.
2. **Prepara el audio** → ajusta el volumen o corta la música al fragmento que quieres.
