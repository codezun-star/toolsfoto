...
/**
 * Recuentos derivados de `TOOLS`. Antes estaban escritos a mano en las
 * descripciones de las 5 páginas de categoría y se habían quedado obsoletos
 * (imagen decía 48 de 60, PDF 32 de 43, vídeo 31 de 42, audio 42 de 53 y
 * developer 31 de 43). Calcularlos evita que vuelvan a desfasarse.
 */
const N = {
  total: TOOLS.length,
  imagen: TOOLS.filter(t => t.domain === 'imagen').length,
  pdf: TOOLS.filter(t => t.domain === 'pdf').length,
  video: TOOLS.filter(t => t.domain === 'video').length,
  audio: TOOLS.filter(t => t.domain === 'audio').length,
  developer: TOOLS.filter(t => t.domain === 'developer').length,
};
...
export const PAGE_SEO: Record<string, PageSEO> = {
  home: {
    ...
    description: `${N.total} herramientas online gratis para imagen, PDF, vídeo, audio y developers. Comprime, convierte, recorta y edita sin registro, en tu navegador.`,
  ...
  paleta: {
    ...
    description: 'Saca los colores dominantes de cualquier foto y descarga su paleta lista para moodboards, branding e inspiración de diseño. Con los códigos HEX incluidos.',
  ...
  'colores-imagen': {
    ...
    description: 'Obtén los códigos HEX, RGB y HSL de los colores de cualquier imagen, con variables CSS listas para copiar. Cuentagotas online para developers y maquetadores.',
    canonical: 'https://toolsfoto.com/colores-imagen',
  },
  'eliminar-exif': {
    title: 'Eliminar metadatos EXIF de imágenes gratis | ToolsFoto',
    description: 'Borra GPS, modelo de cámara, fecha y todos los metadatos EXIF de tus fotos antes de publicarlas en redes, marketplaces o tu web. Protege tu privacidad.',
    canonical: 'https://toolsfoto.com/eliminar-exif',
  },
  'imagen-a-base64': {
    title: 'Convertir imagen a Base64 online gratis | ToolsFoto',
    description: 'Codifica cualquier imagen en Base64 para incrustarla en HTML, CSS, JSON o JavaScript. Genera Data URIs listos para webs, correos HTML y APIs.',
    canonical: 'https://toolsfoto.com/imagen-a-base64',
  },
  'generar-favicon': {
    title: 'Generar favicon PNG online gratis — todos los tamaños | ToolsFoto',
    description: 'Genera los 5 tamaños estándar de favicon (de 16×16 a 180×180) desde cualquier imagen y copia las etiquetas HTML para WordPress, Wix o Shopify.',
  ...
  'foto-carnet': {
    ...
    description: 'Crea fotos de carnet para DNI, pasaporte, carnet de conducir y visado con los tamaños oficiales. Recorte automático, descarga en PNG.',
    canonical: 'https://toolsfoto.com/foto-carnet',
  },
  'redimensionar-redes': {
    title: 'Redimensionar imagen para redes sociales gratis | ToolsFoto',
    description: 'Ajusta tus fotos al tamaño perfecto para Instagram, YouTube, Twitter, Facebook, TikTok y LinkedIn con un clic.',
  ...
  'thumbnail-youtube': {
    ...
    description: 'Diseña miniaturas profesionales para YouTube en 1280×720. Sube tu fondo, añade texto con fuente y color personalizables. Descarga en PNG.',
    canonical: 'https://toolsfoto.com/thumbnail-youtube',
  },
  'imagenes-a-gif': {
    title: 'Crear GIF animado desde imágenes online gratis | ToolsFoto',
    description: 'Convierte varias imágenes JPG o PNG en un GIF animado. Ajusta la velocidad, el tamaño y hasta 20 fotogramas. Optimización de paleta con FFmpeg.wasm.',
  ...
  'marca-agua-pdf': {
    ...
    description: 'Añade texto en marca de agua diagonal a todas las páginas de tu PDF. Controla la opacidad, color y tamaño. Sin subir archivos al servidor.',
    canonical: 'https://toolsfoto.com/marca-agua-pdf',
  },
  'numerar-paginas-pdf': {
    title: 'Numerar páginas de PDF online gratis | ToolsFoto',
    description: 'Añade numeración automática a las páginas de tu PDF. Elige posición, número inicial y formato. Procesamiento 100% local en el navegador.',
  ...
  'pdf-a-png': {
    ...
    description: 'Convierte cada página de tu PDF en una imagen PNG de alta calidad sin pérdida. Ideal para PDFs con texto y gráficos vectoriales.',
    canonical: 'https://toolsfoto.com/pdf-a-png',
  },
  'reordenar-paginas-pdf': {
    title: 'Reordenar páginas de PDF online gratis | ToolsFoto',
    description: 'Cambia el orden de las páginas de tu PDF de forma visual. Mueve páginas arriba o abajo y descarga el PDF reordenado.',
    canonical: 'https://toolsfoto.com/reordenar-paginas-pdf',
  },
  'recortar-pdf': {
    title: 'Recortar márgenes de PDF online gratis | ToolsFoto',
    description: 'Elimina los márgenes en blanco de todas las páginas de tu PDF ajustando el recorte en milímetros. Ideal para documentos escaneados. Sin registro, 100% local.',
  ...
  'generar-qr': {
    ...
    description: 'Crea códigos QR para URLs, textos o contactos al instante. Personaliza el tamaño, colores y corrección de errores. Descarga en PNG.',
    canonical: 'https://toolsfoto.com/generar-qr',
  },
  'formatear-json': {
    title: 'Formatear y validar JSON online gratis | ToolsFoto',
    description: 'Formatea, valida y minifica JSON en segundos. Indentación con 2 o 4 espacios, minificado o validación con detección de errores. Copia o descarga el resultado.',
    canonical: 'https://toolsfoto.com/formatear-json',
  },
  'codificar-url': {
    title: 'Codificar y decodificar URL online gratis | ToolsFoto',
    description: 'Codifica o decodifica URLs y componentes de URL al instante con encodeURI y encodeURIComponent. Resultado en tiempo real. Sin registro, sin subir datos.',
    canonical: 'https://toolsfoto.com/codificar-url',
  },
  'convertir-color': {
    title: 'Conversor de colores HEX RGB HSL online gratis | ToolsFoto',
    description: 'Convierte colores entre HEX, RGB, HSL y HSB al instante. Previsualización en tiempo real y copia con un clic.',
  ...
  'cambiar-velocidad': {
    ...
    description: 'Acelera o ralentiza tu vídeo de 0.25x a 2x con corrección de tono en el audio. Procesamiento 100% local con FFmpeg.wasm.',
    canonical: 'https://toolsfoto.com/cambiar-velocidad',
  },
  'anadir-audio-video': {
    title: 'Añadir audio a vídeo online gratis | ToolsFoto',
    description: 'Reemplaza o mezcla el audio de tu vídeo con otro archivo de audio. El vídeo no se re-codifica. Procesamiento 100% local con FFmpeg.wasm.',
  ...
  'revertir-audio': {
    ...
    description: 'Invierte cualquier archivo de audio para reproducirlo de atrás hacia adelante. Efecto reverse para producción musical y audio creativo. FFmpeg.wasm, 100% local.',
  ...
  'rotar-video': {
    ...
    description: 'Gira tu vídeo grabado en orientación incorrecta: 90° a la derecha, 90° a la izquierda o 180°. El audio se preserva. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/rotar-video',
  },
  'unir-videos': {
    title: 'Unir vídeos online gratis — fusionar clips en uno solo | ToolsFoto',
    description: 'Combina varios vídeos MP4, WebM o MOV en un único archivo. Reordena los clips antes de unirlos. Procesamiento 100% local con FFmpeg.wasm.',
    canonical: 'https://toolsfoto.com/unir-videos',
  },
  'silenciar-video': {
    title: 'Silenciar vídeo online gratis — eliminar audio de vídeo | ToolsFoto',
    description: 'Elimina el audio de cualquier vídeo con un solo clic. El vídeo se copia sin re-codificar para preservar la calidad original. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/silenciar-video',
  },
  'capturar-fotograma': {
    title: 'Extraer un fotograma exacto de un vídeo como imagen PNG | ToolsFoto',
    description: 'Saca el fotograma de un segundo exacto de tu vídeo como imagen PNG en alta calidad, ideal para capturas y screenshots. FFmpeg.wasm, 100% local.',
  ...
  'base64-texto': {
    ...
    description: 'Convierte texto a Base64 y decodifica Base64 a texto al instante. Soporta Unicode y emojis. Sin registro, sin instalar nada.',
    canonical: 'https://toolsfoto.com/base64-texto',
  },
  'minificador-css': {
    title: 'Minificador CSS online gratis — comprimir CSS al instante | ToolsFoto',
    description: 'Minifica tu CSS eliminando espacios, comentarios y saltos de línea. Muestra el porcentaje de reducción y también formatea CSS minificado.',
    canonical: 'https://toolsfoto.com/minificador-css',
  },
  'csv-a-json': {
    title: 'Convertir CSV a JSON online gratis | ToolsFoto',
    description: 'Transforma datos CSV a JSON estructurado y viceversa. Primera fila como cabecera automática. Resultado formateado y descargable.',
    canonical: 'https://toolsfoto.com/csv-a-json',
  },
  'calcular-hash': {
    title: 'Calcular hash SHA-256 SHA-1 SHA-512 online gratis | ToolsFoto',
    description: 'Genera el hash criptográfico de texto o archivos con SHA-1, SHA-256, SHA-384 y SHA-512. Usa la Web Crypto API nativa.',
  ...
  'imagen-a-webp': {
    ...
    description: 'Convierte tus imágenes JPG o PNG a formato WebP y reduce el tamaño hasta un 30% sin perder calidad. Elige la calidad de compresión.',
  ...
  'anadir-texto-pdf': {
    ...
    description: 'Inserta texto personalizado en cualquier posición de tu PDF. Elige página, posición X/Y, tamaño de fuente y color.',
  ...
  'ajustar-hsb': {
    ...
    description: 'Ajusta el tono (hue), saturación, brillo y contraste de tus imágenes con sliders en tiempo real. Preview instantáneo, sin registro, sin subir archivos.',
    canonical: 'https://toolsfoto.com/ajustar-hsb',
  },
  'efecto-boceto': {
    title: 'Efecto boceto a lápiz online gratis | ToolsFoto',
    description: 'Convierte tus fotos en bocetos artísticos a lápiz con la técnica color dodge. Ajusta la suavidad del trazo. Sin registro, sin subir imágenes.',
  ...
  mosaico: {
    ...
    description: 'Repite tu imagen en una cuadrícula de hasta 6×6 tiles. Perfecto para fondos, papeles de pared y diseño gráfico.',
    canonical: 'https://toolsfoto.com/mosaico',
  },
  'efecto-duotono': {
    title: 'Efecto duotono a imagen online gratis | ToolsFoto',
    description: 'Aplica efectos duotono profesionales de dos colores a tus imágenes. 5 presets populares y colores personalizados. Sin registro, sin subir archivos.',
  ...
  'anadir-imagen-pdf': {
    ...
    description: 'Inserta imágenes JPG o PNG en cualquier página de tu PDF con control de posición y tamaño. Perfecto para firmas y sellos.',
    canonical: 'https://toolsfoto.com/anadir-imagen-pdf',
  },
  'pdf-en-blanco': {
    title: 'Crear PDF en blanco online gratis | ToolsFoto',
    description: 'Genera PDFs en blanco en A4, A3, Carta, Legal y A5. Elige la orientación y el número de páginas. Sin registro, sin instalación. Procesamiento 100% local.',
    canonical: 'https://toolsfoto.com/pdf-en-blanco',
  },
  'voltear-video': {
    title: 'Voltear vídeo online gratis — espejo horizontal y vertical | ToolsFoto',
    description: 'Voltea tu vídeo en espejo horizontal, vertical o en ambos ejes. El audio se preserva. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/voltear-video',
  },
  'recortar-area-video': {
    title: 'Recortar área de vídeo online gratis | ToolsFoto',
    description: 'Recorta un área específica de tu vídeo definiendo ancho, alto y posición en píxeles. El audio se preserva. FFmpeg.wasm, 100% local.',
  ...
  'marca-agua-video': {
    ...
    description: 'Incrusta texto como marca de agua permanente en tu vídeo. Posición, tamaño y opacidad ajustables. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/marca-agua-video',
  },
  'agregar-fade-audio': {
    title: 'Añadir fade in y fade out a audio online gratis | ToolsFoto',
    description: 'Aplica entrada y salida gradual (fade in/fade out) a cualquier audio. Duración configurable de forma independiente. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/agregar-fade-audio',
  },
  'mezclar-audios': {
    title: 'Mezclar dos audios online gratis | ToolsFoto',
    description: 'Combina dos pistas de audio en una sola con control de volumen independiente. Perfecto para música de fondo y locución. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/mezclar-audios',
  },
  'cambiar-tono': {
    title: 'Cambiar tono de audio online gratis — pitch shifter | ToolsFoto',
    description: 'Sube o baja el tono musical de tu audio en semitonos sin cambiar la velocidad. De -12 a +12 semitonos. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/cambiar-tono',
  },
  'regex-tester': {
    title: 'Tester de expresiones regulares (Regex) online gratis | ToolsFoto',
    description: 'Prueba tus expresiones regulares JavaScript con resaltado de coincidencias en tiempo real. Soporta flags g, i, m, s y grupos de captura.',
    canonical: 'https://toolsfoto.com/regex-tester',
  },
  'generador-uuid': {
    title: 'Generador de UUID v4 online gratis | ToolsFoto',
    description: 'Genera UUIDs v4 criptográficamente seguros al instante. Hasta 100 UUIDs de una vez, con opciones de formato. Web Crypto API. Sin registro, sin subir datos.',
    canonical: 'https://toolsfoto.com/generador-uuid',
  },
  'contador-palabras': {
    title: 'Contador de palabras online gratis | ToolsFoto',
    description: 'Cuenta palabras, caracteres, frases, párrafos y tiempo de lectura en tiempo real. Estadísticas instantáneas sin hacer clic. Sin registro, sin subir texto.',
    canonical: 'https://toolsfoto.com/contador-palabras',
  },
  'convertir-timestamp': {
    title: 'Convertir Unix timestamp a fecha online gratis | ToolsFoto',
    description: 'Convierte timestamps Unix a fechas legibles y viceversa. Detecta segundos o milisegundos y muestra local, UTC e ISO 8601.',
  ...
  'generador-contrasenas': {
    ...
    description: 'Genera contraseñas seguras con la Web Crypto API. Longitud, mayúsculas, minúsculas, números y símbolos configurables. Hasta 20 contraseñas a la vez.',
  ...
  'gradiente-css': {
    ...
    description: 'Crea gradientes CSS lineales y radiales con preview en tiempo real. Hasta 5 colores, control de ángulo y posición. Copia el código CSS listo para usar.',
  ...
  'anadir-silencio': {
    ...
    description: 'Añade segundos de silencio al inicio y/o al final de cualquier archivo de audio. Configurable hasta 10 segundos en cada extremo. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/anadir-silencio',
  },
  'convertir-a-mono': {
    title: 'Convertir audio estéreo a mono online gratis | ToolsFoto',
    description: 'Mezcla los canales estéreo de cualquier audio en uno solo (mono). Reduce el tamaño del archivo a la mitad. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/convertir-a-mono',
  },
  'comprimir-objetivo': {
    title: 'Comprimir imagen a tamaño máximo en KB online gratis | ToolsFoto',
    description: 'Comprime tu imagen a un tamaño exacto en KB: 100, 200, 500 o el que necesites. Ideal para formularios, portales de empleo y trámites con límite de peso.',
    canonical: 'https://toolsfoto.com/comprimir-objetivo',
  },
  'fondo-degradado': {
    title: 'Añadir fondo degradado a imagen online gratis | ToolsFoto',
    description: 'Añade un fondo con degradado lineal o radial a tu imagen o PNG transparente. 5 presets y colores personalizables. Canvas API, 100% en el navegador.',
  ...
  nitidez: {
    ...
    description: 'Enfoca y aumenta la nitidez de tus imágenes con el algoritmo unsharp mask. Intensidad ajustable con slider. Canvas API, 100% en el navegador.',
  ...
  'efecto-oleo': {
    ...
    description: 'Transforma tus fotos en pinturas al óleo artísticas. Radio de pincel ajustable. Canvas API con análisis de vecindades de píxeles, 100% en el navegador.',
  ...
  'intercalar-pdfs': {
    ...
    description: 'Combina dos PDFs alternando sus páginas (A1, B1, A2, B2…). Ideal para escaneos de anverso y reverso. pdf-lib, 100% local.',
    canonical: 'https://toolsfoto.com/intercalar-pdfs',
  },
  'escalar-pdf': {
    title: 'Escalar PDF a A4, Carta o tamaño estándar online gratis | ToolsFoto',
    description: 'Redimensiona todas las páginas de tu PDF a un tamaño estándar (A4, A3, Carta, Legal) manteniendo las proporciones. pdf-lib, 100% local.',
    canonical: 'https://toolsfoto.com/escalar-pdf',
  },
  'encabezado-pie-pdf': {
    title: 'Añadir encabezado y pie de página a PDF online gratis | ToolsFoto',
    description: 'Inserta texto personalizado en la cabecera y el pie de cada página de tu PDF. Tamaño de fuente y márgenes configurables. pdf-lib, 100% local.',
  ...
  'duplicar-paginas-pdf': {
    ...
    description: 'Duplica páginas específicas de tu PDF el número de veces que necesites. Las copias se insertan tras la página original. pdf-lib, 100% local.',
    canonical: 'https://toolsfoto.com/duplicar-paginas-pdf',
  },
  'bucle-video': {
    title: 'Bucle de vídeo online gratis — repetir vídeo N veces | ToolsFoto',
    description: 'Crea un vídeo en bucle repitiendo tu clip el número de veces que quieras en un único MP4. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/bucle-video',
  },
  'audio-a-video': {
    title: 'Convertir audio a vídeo online gratis — audio a MP4 | ToolsFoto',
    description: 'Convierte cualquier audio en vídeo MP4 con imagen de fondo o color sólido. Perfecto para subir podcasts y música a YouTube. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/audio-a-video',
  },
  'revertir-video': {
    title: 'Revertir vídeo online gratis — reproducir vídeo al revés | ToolsFoto',
    description: 'Invierte el orden de los fotogramas de tu vídeo para reproducirlo al revés. El audio también se invierte. FFmpeg.wasm, 100% local.',
  ...
  'eco-audio': {
    ...
    description: 'Aplica efecto de eco configurable a tu audio. Controla el retardo y decaimiento. FFmpeg aecho, 100% local. Sin registro, sin subir archivos al servidor.',
    canonical: 'https://toolsfoto.com/eco-audio',
  },
  'convertir-a-estereo': {
    title: 'Convertir audio mono a estéreo online gratis | ToolsFoto',
    description: 'Convierte cualquier audio mono en estéreo duplicando el canal. Compatible con MP3, WAV, OGG, AAC y FLAC. FFmpeg.wasm, 100% local.',
  ...
  'normalizar-audio': {
    ...
    description: 'Normaliza el volumen de tu audio al estándar EBU R128. Presets: streaming (-14 LUFS), podcast (-16 LUFS), broadcast (-23 LUFS). FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/normalizar-audio',
  },
  'formateador-sql': {
    title: 'Formateador SQL online gratis — formatear y minificar SQL | ToolsFoto',
    description: 'Formatea consultas SQL con indentación automática y palabras clave en mayúsculas. También minifica SQL a una línea. Sin dependencias externas.',
  ...
  'comparar-texto': {
    ...
    description: 'Compara dos textos línea a línea y resalta las diferencias con colores. Algoritmo LCS. Muestra líneas añadidas, eliminadas e iguales.',
  ...
  ruido: {
    ...
    description: 'Aplica ruido aleatorio y efecto de grano fotográfico a tus imágenes. Intensidad y modo monocromático configurables. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/ruido',
  },
  posterizar: {
    title: 'Posterizar imagen online gratis — efecto póster artístico | ToolsFoto',
    description: 'Reduce los niveles de color de tu imagen con efecto posterización. De 2 a 8 niveles ajustables. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/posterizar',
  },
  vigneta: {
    title: 'Añadir viñeta a imagen online gratis — vignette effect | ToolsFoto',
    description: 'Aplica efecto de viñeteado en los bordes de tu imagen. Intensidad y color ajustables. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/vigneta',
  },
  solarizar: {
    title: 'Solarizar imagen online gratis — efecto Sabattier | ToolsFoto',
    description: 'Aplica el efecto de solarización fotográfica (Sabattier) a tu imagen. Umbral ajustable con 3 presets. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/solarizar',
  },
  'insertar-pagina-pdf': {
    title: 'Insertar páginas en blanco en PDF online gratis | ToolsFoto',
    description: 'Añade una o varias páginas en blanco dentro de tu PDF en la posición que elijas. pdf-lib, 100% local. Sin registro, sin subir archivos al servidor.',
    canonical: 'https://toolsfoto.com/insertar-pagina-pdf',
  },
  'fondo-color-pdf': {
    title: 'Añadir fondo de color a PDF online gratis | ToolsFoto',
    description: 'Aplica un color de fondo sólido a todas las páginas de tu PDF conservando el contenido original. pdf-lib embedPage, 100% local.',
    canonical: 'https://toolsfoto.com/fondo-color-pdf',
  },
  'aplanar-pdf': {
    title: 'Aplanar formulario PDF online gratis — flatten PDF form | ToolsFoto',
    description: 'Convierte los campos interactivos de formularios PDF en texto estático no editable. pdf-lib form.flatten(), 100% local.',
  ...
  'boomerang-video': {
    ...
    description: 'Crea el clásico efecto boomerang: el vídeo avanza y retrocede en un bucle continuo. Configura el número de ciclos. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/boomerang-video',
  },
  'ajustar-volumen-video': {
    title: 'Ajustar volumen de vídeo online gratis | ToolsFoto',
    description: 'Sube o baja el volumen del audio de un vídeo en dB sin re-codificar el stream de vídeo. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/ajustar-volumen-video',
  },
  'ecualizador-audio': {
    title: 'Ecualizador de audio online gratis — EQ 3 bandas | ToolsFoto',
    description: 'Ajusta graves, medios y agudos de tu audio con un ecualizador de 3 bandas. Presets Rock, Pop, Voz y Clásica. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/ecualizador-audio',
  },
  'reducir-ruido-audio': {
    title: 'Reducir ruido de audio online gratis — noise reduction | ToolsFoto',
    description: 'Elimina el ruido de fondo de tus grabaciones con el filtro anlmdn de FFmpeg. Tres niveles de reducción. FFmpeg.wasm, 100% local.',
  ...
  'metadatos-pdf': {
    ...
    description: 'Lee y modifica el título, autor, asunto y palabras clave de cualquier PDF. Guarda el PDF con los nuevos metadatos. pdf-lib, 100% local.',
  ...
  'comparar-imagenes': {
    ...
    description: 'Compara dos imágenes con un slider interactivo de antes/después: evalúa compresión, retoques o cambios de diseño arrastrando la línea.',
    canonical: 'https://toolsfoto.com/comparar-imagenes',
  },
  placeholder: {
    title: 'Generador de imágenes placeholder online gratis | ToolsFoto',
    description: 'Crea imágenes placeholder con el tamaño, color y texto que necesites. Presets 16:9, 1:1, 4:3, OG y Banner. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/placeholder',
  },
  'efecto-glitch': {
    title: 'Efecto glitch en imagen online gratis — RGB shift | ToolsFoto',
    description: 'Aplica un efecto glitch artístico con desplazamiento de canales RGB y cortes aleatorios. Genera variaciones únicas. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/efecto-glitch',
  },
  'tilt-shift': {
    title: 'Efecto tilt-shift online gratis — miniatura fotográfica | ToolsFoto',
    description: 'Simula el efecto tilt-shift de maqueta miniatura con desenfoque gaussiano fuera de la banda de enfoque. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/tilt-shift',
  },
  'imagen-a-ico': {
    title: 'Convertir imagen a ICO online gratis — favicon .ico | ToolsFoto',
    description: 'Convierte cualquier imagen a formato .ico con múltiples tamaños (16, 32, 48, 64, 128, 256 px). ICO moderno con PNG embebido. Canvas API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/imagen-a-ico',
  },
  'sellar-pdf': {
    title: 'Sellar PDF online gratis — añadir sello de texto | ToolsFoto',
    description: 'Estampa un sello de texto diagonal (BORRADOR, CONFIDENCIAL, APROBADO…) en todas las páginas de tu PDF. Color y opacidad ajustables. pdf-lib, 100% local.',
    canonical: 'https://toolsfoto.com/sellar-pdf',
  },
  'pdf-a-svg': {
    title: 'Convertir PDF a SVG online gratis | ToolsFoto',
    description: 'Convierte cada página de tu PDF a un archivo SVG. Descarga páginas individuales o todas en un ZIP. pdfjs-dist, 100% local.',
    canonical: 'https://toolsfoto.com/pdf-a-svg',
  },
  'comparar-pdfs': {
    title: 'Comparar dos PDFs online gratis — vista en paralelo | ToolsFoto',
    description: 'Compara dos PDFs página a página en una vista sincronizada. Navegación paralela y escala ajustable. pdfjs-dist, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/comparar-pdfs',
  },
  'indice-pdf': {
    title: 'Extraer índice de PDF online gratis — tabla de contenidos | ToolsFoto',
    description: 'Obtén el índice o tabla de contenidos de cualquier PDF con sus números de página. Usa los marcadores integrados o detecta encabezados automáticamente.',
    canonical: 'https://toolsfoto.com/indice-pdf',
  },
  'anadir-subtitulos': {
    title: 'Añadir subtítulos a vídeo online gratis — incrustar SRT | ToolsFoto',
    description: 'Incrusta subtítulos de un archivo .SRT en tu vídeo permanentemente. Los subtítulos se renderizan en canvas y se superponen con FFmpeg.wasm. 100% local.',
    canonical: 'https://toolsfoto.com/anadir-subtitulos',
  },
  'extraer-fotogramas': {
    title: 'Extraer fotogramas de vídeo online gratis — frames a ZIP | ToolsFoto',
    description: 'Exporta fotogramas de tu vídeo en JPG o PNG a la tasa de FPS elegida. Se descargan en un archivo ZIP. FFmpeg.wasm, 100% local.',
  ...
  'miniatura-video': {
    ...
    description: 'Crea la miniatura o portada de cualquier vídeo al instante en PNG o JPG con un slider de tiempo. Rápido, sin FFmpeg ni subir archivos.',
    canonical: 'https://toolsfoto.com/miniatura-video',
  },
  'fundido-video': {
    title: 'Fundido a negro en vídeo online gratis — fade in fade out | ToolsFoto',
    description: 'Añade transiciones de fundido a negro (fade in y fade out) al inicio y final de tu vídeo. Configura la duración de cada efecto. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/fundido-video',
  },
  'escala-grises-video': {
    title: 'Vídeo en escala de grises online gratis — sepia y negativo | ToolsFoto',
    description: 'Convierte tu vídeo a escala de grises, sepia o negativo. Efectos de color clásicos aplicados con FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/escala-grises-video',
  },
  'fotogramas-a-video': {
    title: 'Fotos a vídeo online gratis — crear slideshow MP4 | ToolsFoto',
    description: 'Convierte tus fotos en un vídeo slideshow MP4. Configura la duración por imagen, la resolución y el orden. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/fotogramas-a-video',
  },
  'gif-a-video': {
    title: 'GIF a MP4 online gratis — convertir GIF animado a vídeo | ToolsFoto',
    description: 'Convierte GIFs animados a vídeo MP4 hasta 10 veces más ligero. H.264, compatible con todas las plataformas. FFmpeg.wasm, 100% local.',
  ...
  'detector-bpm': {
    ...
    description: 'Detecta automáticamente los BPM (beats per minute) de tu música o audio. Análisis de energía con Web Audio API, sin IA ni servidores.',
    canonical: 'https://toolsfoto.com/detector-bpm',
  },
  'separar-voz': {
    title: 'Separar voz de música online gratis — vocal remover | ToolsFoto',
    description: 'Extrae la voz y el instrumental de cualquier audio estéreo con el algoritmo de cancelación de canal central. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/separar-voz',
  },
  'transcribir-audio': {
    title: 'Transcribir audio a texto online gratis — voz a texto | ToolsFoto',
    description: 'Convierte voz a texto en tiempo real con la Web Speech API. Soporta español, inglés, francés, alemán, italiano, portugués y catalán.',
    canonical: 'https://toolsfoto.com/transcribir-audio',
  },
  'afinar-audio': {
    title: 'Afinar audio y voz online gratis — corrige la afinación | ToolsFoto',
    description: 'Corrige la afinación de voz e instrumentos desafinados ajustando el tono en semitonos sin cambiar la velocidad, con vibrato opcional. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/afinar-audio',
  },
  'minificador-svg': {
    title: 'Minificador SVG online gratis — comprimir SVG | ToolsFoto',
    description: 'Reduce el tamaño de tus SVGs eliminando metadatos, comentarios y atributos de Inkscape/Sodipodi. Pega código o sube un archivo. Sin dependencias.',
  ...
  'convertir-fuente': {
    ...
    description: 'Convierte fuentes tipográficas entre TTF, OTF y WOFF directamente en el navegador. Conversión sin pérdida: todas las tablas SFNT se preservan.',
  ...
  'robotizar-voz': {
    ...
    description: 'Aplica efecto de voz robótica, metálica o alienígena a cualquier audio con 4 presets. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/robotizar-voz',
  },
  'dividir-audio': {
    title: 'Dividir audio en dos partes online gratis | ToolsFoto',
    description: 'Divide cualquier audio en dos partes en el punto de tiempo exacto que elijas. Descarga ambas partes. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/dividir-audio',
  },
  'audio-a-fragmentos': {
    title: 'Dividir audio en fragmentos iguales online gratis | ToolsFoto',
    description: 'Divide un audio en 2 a 10 fragmentos de igual duración automáticamente. Descarga cada fragmento por separado. FFmpeg.wasm, 100% local.',
  ...
  'insertar-audio': {
    ...
    description: 'Inserta un audio secundario en el interior de otro en el tiempo exacto que elijas. FFmpeg.wasm, 100% local. Sin registro, sin subir archivos al servidor.',
    canonical: 'https://toolsfoto.com/insertar-audio',
  },
  'reemplazar-segmento': {
    title: 'Reemplazar segmento de audio con silencio online gratis | ToolsFoto',
    description: 'Silencia un intervalo de tiempo de tu audio manteniendo la duración total. FFmpeg.wasm, 100% local. Sin registro, sin subir archivos al servidor.',
    canonical: 'https://toolsfoto.com/reemplazar-segmento',
  },
  'audio-a-base64': {
    title: 'Convertir audio a Base64 online gratis — audio a data URI | ToolsFoto',
    description: 'Codifica cualquier archivo de audio en Base64 o data URI. También decodifica Base64 a archivo. Sin servidores, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/audio-a-base64',
  },
  'convertir-a-flac': {
    title: 'Convertir audio a FLAC online gratis — formato lossless | ToolsFoto',
    description: 'Convierte cualquier audio a FLAC sin pérdida. Ideal para archivos máster y alta fidelidad. FFmpeg.wasm, 100% local.',
    canonical: 'https://toolsfoto.com/convertir-a-flac',
  },
  'analizar-espectro': {
    title: 'Analizar espectro de audio online gratis — frecuencias PNG | ToolsFoto',
    description: 'Visualiza el espectro de frecuencias de tu audio como gráfica de barras descargable en PNG. Web Audio API + Canvas, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/analizar-espectro',
  },
  'detectar-tono': {
    title: 'Detectar tono y nota musical de audio online gratis | ToolsFoto',
    description: 'Detecta la nota musical dominante y su frecuencia en Hz de cualquier audio. Algoritmo de autocorrelación. Web Audio API, 100% en el navegador.',
    canonical: 'https://toolsfoto.com/detectar-tono',
  },
  'medir-duracion': {
    title: 'Medir duración y metadata de audio online gratis | ToolsFoto',
    description: 'Obtén la duración, sample rate, canales y bitrate de cualquier archivo de audio. Web Audio API, 100% en el navegador.',
  ...
  'compresor-audio': {
    ...
    description: 'Aplica compresión dinámica con control de umbral, ratio, ataque y release. Presets Suave, Podcast, Máster y Heavy. FFmpeg acompressor, 100% local.',
  ...
  'coro-audio': {
    ...
    description: 'Aplica efecto de coro (chorus) para dar profundidad y amplitud a voces e instrumentos con 3 presets. FFmpeg achorus, 100% local.',
    canonical: 'https://toolsfoto.com/coro-audio',
  },
  'telefono-audio': {
    title: 'Efecto teléfono en audio online gratis — telephone sound | ToolsFoto',
    description: 'Simula el sonido de teléfono, radio AM o intercomunicador con filtros de banda estrecha. FFmpeg.wasm, 100% local.',
  ...
  'heic-a-jpg': {
    ...
    description: 'Convierte fotos HEIC y HEIF de iPhone a JPG o PNG compatibles con cualquier dispositivo. Elige la calidad. 100% en tu navegador, sin subir tus fotos.',
    canonical: 'https://toolsfoto.com/heic-a-jpg',
  },
  'pdf-escala-grises': {
    title: 'Convertir PDF a escala de grises (blanco y negro) gratis | ToolsFoto',
    description: 'Convierte un PDF a escala de grises para imprimir ahorrando tinta o unificar documentos. Procesamiento 100% local con pdf.js y pdf-lib. Sin subir archivos.',
    canonical: 'https://toolsfoto.com/pdf-escala-grises',
  },
  'comprimir-gif': {
    title: 'Comprimir GIF online gratis — reducir el tamaño de un GIF | ToolsFoto',
    description: 'Reduce el peso de tus GIF animados ajustando ancho, FPS y colores con paleta optimizada de FFmpeg. Mantiene la animación.',
    canonical: 'https://toolsfoto.com/comprimir-gif',
  },
  'grabar-audio': {
    title: 'Grabar audio y voz online gratis — grabadora de voz | ToolsFoto',
    description: 'Graba voz o sonido desde el micrófono en el navegador y descárgalo en WebM o MP3. Sin instalar apps y sin que tu voz salga de tu dispositivo.',
    canonical: 'https://toolsfoto.com/grabar-audio',
  },
  'formatear-xml': {
    title: 'Formatear y minificar XML online gratis | ToolsFoto',
    description: 'Formatea XML con indentación jerárquica o minifícalo a una sola línea, con validación de sintaxis. Ideal para SOAP, sitemaps y RSS.',
  ...
  imagen: {
    ...
    description: `Comprime, redimensiona, recorta, convierte y edita imágenes online gratis. ${N.imagen} herramientas: JPG, PNG, WebP, AVIF. Elimina fondos con IA.`,
  ...
  video: {
    ...
    description: `Comprime, convierte, recorta, rota y edita vídeos online gratis. ${N.video} herramientas de vídeo: MP4, WebM, GIF. Todo se procesa en tu navegador.`,
    canonical: 'https://toolsfoto.com/video',
  },
  audio: {
    title: 'Herramientas de audio online gratis — MP3, WAV, OGG | ToolsFoto',
    description: `Comprime, convierte, corta, mezcla y normaliza audio online gratis. ${N.audio} herramientas: MP3, WAV, OGG, AAC, FLAC. Todo en tu navegador.`,
